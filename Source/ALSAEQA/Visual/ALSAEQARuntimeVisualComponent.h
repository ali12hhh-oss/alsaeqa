...
UENUM(BlueprintType)
enum class EALSAEQAVisualRole : uint8
{
    Hero,
    Companion,
    Enemy,
...
private:
    void ClearVisual();
    void AddMesh(const TCHAR* AssetPath, const FVector& RelativeLocation, const FVector& RelativeScale, const FRotator& RelativeRotation);
    void AddWeaponVisual();
    void AddStormVisual();
